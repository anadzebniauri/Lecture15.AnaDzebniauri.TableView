...
extension ViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print("AD - horeeeeyy")
        // TODO: show next view (implement here for cell select action)

        guard let detailsPage = navigationController?.storyboard?.instantiateViewController(withIdentifier: "DetailsPage") as? DetailsPage else {
            fatalError("Cant instantiate DetailsPage")
        }
